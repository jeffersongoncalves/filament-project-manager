...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filakit.defaultCurrency' => 'string',
            'filakit.defaultDateDisplayFormat' => 'string',
            'filakit.defaultIsoDateDisplayFormat' => 'string',
            'filakit.defaultDateTimeDisplayFormat' => 'string',
            'filakit.defaultIsoDateTimeDisplayFormat' => 'string',
            'filakit.defaultNumberLocale' => 'NULL',
            'filakit.defaultTimeDisplayFormat' => 'string',
            'filakit.defaultIsoTimeDisplayFormat' => 'string',
            ...
            'filesystems.links.D:\jeffersongoncalves\filament-project-manager\public\storage' => 'string',
...
'database.redis.cache.username','database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','filakit.defaultCurrency',
'filakit.defaultDateDisplayFormat','filakit.defaultIsoDateDisplayFormat','filakit.defaultDateTimeDisplayFormat','filakit.defaultIsoDateTimeDisplayFormat','filakit.defaultNumberLocale',
'filakit.defaultTimeDisplayFormat','filakit.defaultIsoTimeDisplayFormat','filakit.theme_mode','filakit.guest_panel_enabled','filakit.admin_panel_enabled',
'filakit.app_panel_enabled','filakit.favicon.enabled','filakit.favicon.manifest.name','filakit.favicon.logo','filakit.favicon.favicon',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\jeffersongoncalves\\filament-project-manager\\public\\storage','logging.default','logging.deprecations.channel',
...
'filament.file_generation.flags','filament.system_route_prefix','livewire.class_namespace','livewire.view_path','livewire.layout',
...
'filament-infolists::components.entry-wrapper','filament-logo::logo-before','filament-logo::styles','filament-notifications::database-notifications','filament-notifications::notifications',
'filament-panels::auth.pages.edit-profile','filament-panels::components.avatar.tenant','filament-panels::components.avatar.user','filament-panels::components.header.index','filament-panels::components.header.simple',
...
'filament-panels::components.page.simple','filament-panels::components.page.sub-navigation.select','filament-panels::components.page.sub-navigation.sidebar','filament-panels::components.page.sub-navigation.tabs','filament-panels::components.sidebar.group',
...
'filament-panels::components.topbar.item','filament-panels::components.unsaved-action-changes-alert','filament-panels::components.user-menu','filament-panels::livewire.global-search','filament-panels::livewire.sidebar',
'filament-panels::livewire.simple-user-menu','filament-panels::livewire.topbar','filament-panels::pages.page','filament-panels::pages.simple','filament-panels::resources.relation-manager',
'filament-panels::widgets.account-widget','filament-panels::widgets.filament-info-widget','filament-schemas::components.actions','filament-schemas::components.fieldset','filament-schemas::components.flex',
'filament-schemas::components.form','filament-schemas::components.fused-group','filament-schemas::components.grid','filament-schemas::components.image','filament-schemas::components.livewire',
'filament-schemas::components.section','filament-schemas::components.tabs','filament-schemas::components.tabs.tab','filament-schemas::components.text','filament-schemas::components.unordered-list',
'filament-schemas::components.wizard','filament-schemas::components.wizard.step','filament-tables::components.column-manager','filament-tables::components.columns.layout','filament-tables::components.filters',
'filament-tables::components.search-field','filament-tables::components.summary.index','filament-tables::components.summary.row','filament-tables::index','filament-widgets::chart-widget',
...
'filament::components.dropdown.list.index','filament::components.dropdown.list.item','filament::components.fieldset','filament::components.icon','filament::components.icon-button',
